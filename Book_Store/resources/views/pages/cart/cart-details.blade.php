            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="total_area">
                        <ul>
                            <li>Cart sub total <span class="total-price-cart">@if(isset($totalPrice))$ {{$totalPrice}}@else
                                        $ 0 @endif</span></li>
                            <li>Total items <span
                                    class="total-quantity-cart">@if(isset($totalQuantity)){{$totalQuantity}}@else
                                        0 @endif</span></li>
                            <li>Total money <span style="color: orange" class="total-price-cart">@if(isset($totalPrice))$ {{$totalPrice}}@else
                                        $ 0 @endif</span></li>
                        </ul>
